// ============================================================
// FluxionJS V3 — Scene Serializer (Legacy v1 path)
// Preserved verbatim from the v1 implementation.
// Only called when loading scenes with version < 2.
// Do NOT modify — use SceneSerializer.ts for new logic.
// ============================================================
...
export function serializeLegacyScene(scene: Scene, engine: Engine, editorCamera?: THREE.PerspectiveCamera, orbitTarget?: THREE.Vector3): SceneFileData {
...
export async function saveSceneToFile(
  ...
  const data = serializeLegacyScene(scene, engine, editorCamera, orbitTarget);
...
export async function loadSceneFromFile(
  ...
  deserializeLegacyScene(engine, data, scene);
  return data;
}
